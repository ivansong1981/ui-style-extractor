...
description: Extract visual design systems from existing websites into reusable markdown style guides and optional validation pages. Use when analyzing a live site, screenshots, or harvested CSS to document colors, typography, spacing, layout, components, motion, and design rules, or when generating new UI that should match a reference site's visual language without copying its content.
---
